...
NGame = {
	...
	END_DATE = "1949.1.1.1",
	MAP_SCALE_PIXEL_TO_KM = 2,					-- Yes, I did the math too UwU. Base game is 7.114, and we have 1.507 so there's a 4,74 factor. Still, I nerfed it a bit cause planes had too much range TwT
...
NDiplomacy = {
	...
	GUARANTEE_COST = 2500,							-- Scale with the number of already guaranteed countries.
...
NBuildings = {
	...
	RADAR_RANGE_BASE = 0,				-- Radar range base, first level radar will be this + min, best radar will be this + max
	RADAR_RANGE_MIN = 100,				-- Radar range (from state center to province center) in measure of map pixels. Exluding techs.
	RADAR_RANGE_MAX = 600,				-- Range is interpolated between building levels 1-15.
	...
	BASE_FACTORY_REPAIR = 0.2,			-- Default repair rate before factories are taken into account
	BASE_FACTORY_REPAIR_FACTOR = 1.3,	-- Factory speed modifier when repairing.
	...
	INFRASTRUCTURE_RESOURCE_BONUS = 0.0, -- multiplactive resource bonus for each level of (non damaged) infrastructure
},
...
NMilitary = {
	...
	WAR_SCORE_LOSSES_RATIO = 0.05,				-- Scale how much losses will affect warscore ( per 1000 losses ).
...
NAir = {
	AIR_WING_FLIGHT_SPEED_MULT = 0.08,					-- Global speed multiplier for airplanes (affects fe.transferring to another base)
...
NNavy = {
	...
	AMPHIBIOUS_INVADE_SPEED_BASE = 2.0, 							-- every hour movement progress on amphibious invasion
	AMPHIBIOUS_INVADE_MOVEMENT_COST = 24.0, 						-- total progress cost of movement while amphibious invading
	...
	NAVAL_SPEED_MODIFIER = 0.2,	                    				-- basic speed control
	NAVAL_RANGE_TO_INGAME_DISTANCE = 0.48,							-- Scale the ship stats "naval_range" to the ingame distance
	...
	NAVAL_TRANSFER_BASE_SPEED = 24,                                  -- base speed of units on water being transported
